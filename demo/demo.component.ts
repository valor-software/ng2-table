...
@Component({
  ...
  template: `
    <main class="bd-pageheader">
      <div class="container">
        <h1>ng2-expanding-table</h1>
        <p>Native Angular2 directives for Table</p>
        <a class="btn btn-primary" href="https://github.com/reseract/ng2-expanding-table">View on GitHub</a>
        <div class="row">
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted text-center"><a href="https://github.com/reseract/ng2-expanding-table">ng2-expanding-table</a> is maintained by <a href="https://ract.io">Reseract</a>.</p>
      </div>
    </footer>
  `
})
