System.registerDynamic("ng2-table/components/table/ng-table.component", ["@angular/core", "@angular/common", "./ng-table-sorting.directive"], true, function($__require, exports, module) {
  ...
  var NgTableComponent = (function() {
    function NgTableComponent(elementRef) {
      this.rows = [];
      this.config = {};
    ...
    }), __metadata('design:paramtypes', [core_1.ElementRef])], NgTableComponent);
...
System.registerDynamic("ng2-table/components/table/ng-table-column.component", ["@angular/core"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var core_1 = $__require('@angular/core');
  var NgTableColumnComponent = (function() {
    function NgTableColumnComponent() {}
    NgTableColumnComponent = __decorate([core_1.Component({
      selector: 'ng-column',
      template: "<div>Hello World</div>\n"
    }), __metadata('design:paramtypes', [])], NgTableColumnComponent);
    return NgTableColumnComponent;
  }());
  exports.NgTableColumnComponent = NgTableColumnComponent;
  return module.exports;
});
...
System.registerDynamic("ng2-table/components/ng-table-directives", ["./table/ng-table.component", "./table/ng-table-column.component", "./table/ng-table-filtering.directive", "./table/ng-table-paging.directive", "./table/ng-table-sorting.directive"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var ng_table_column_component_1 = $__require('./table/ng-table-column.component');
  ...
  exports.NG_TABLE_DIRECTIVES = [ng_table_component_1.NgTableComponent, ng_table_column_component_1.NgTableColumnComponent, ng_table_filtering_directive_1.NgTableFilteringDirective, ng_table_paging_directive_1.NgTablePagingDirective, ng_table_sorting_directive_1.NgTableSortingDirective];
  return module.exports;
});

System.registerDynamic("ng2-table/ng2-table", ["./components/table/ng-table.component", "./components/table/ng-table-column.component", "./components/table/ng-table-filtering.directive", "./components/table/ng-table-paging.directive", "./components/table/ng-table-sorting.directive", "./components/ng-table-directives"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var ng_table_column_component_1 = $__require('./components/table/ng-table-column.component');
  ...
  exports.default = {directives: [ng_table_component_1.NgTableComponent, ng_table_column_component_1.NgTableColumnComponent, ng_table_filtering_directive_1.NgTableFilteringDirective, ng_table_sorting_directive_1.NgTableSortingDirective, ng_table_paging_directive_1.NgTablePagingDirective]};
  return module.exports;
});
